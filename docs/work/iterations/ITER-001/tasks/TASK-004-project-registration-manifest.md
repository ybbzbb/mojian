...
- 2026-07-07 [qa-agent] status reviewing → done：QA Verification 2/2 通过（cargo build --workspace exit 0；cargo test -p mojian-core project 4 passed 0 failed，含 register→load 得 style_sampling 与 mojian.toml 往返断言）
